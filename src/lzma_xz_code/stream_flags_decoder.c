...
// xz-5.0.1/src/liblzma/common/stream_flags_decoder.c:16: //
...
// xz-5.0.1/src/liblzma/common/stream_flags_decoder.c:30: //
extern
LZMA_API(lzma_ret)
...
// xz-5.0.1/src/liblzma/common/stream_flags_decoder.c:60: //
extern
LZMA_API(lzma_ret)
lzma_stream_footer_decode(lzma_stream_flags * options, const uint8_t * in)
{
	// Magic
	if (memcmp
	    (in + sizeof(uint32_t) * 2 + LZMA_STREAM_FLAGS_SIZE,
