...
// xz-5.0.1/src/liblzma/simple/ia64.c:17: //
static size_t
ia64_code(lzma_simple * simple lzma_attribute((unused)), uint32_t now_pos,
...
// xz-5.0.1/src/liblzma/simple/ia64.c:83: //
static lzma_ret
ia64_coder_init(lzma_next_coder * next, lzma_allocator * allocator,
		const lzma_filter_info * filters, bool is_encoder)
{
	return lzma_simple_coder_init(next, allocator, filters, &ia64_code, 0,
				      16, 16, is_encoder);
}

// xz-5.0.1/src/liblzma/simple/ia64.c:97: //
extern lzma_ret
