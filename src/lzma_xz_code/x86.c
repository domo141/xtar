...
// xz-5.0.1/src/liblzma/simple/x86.c:20: //
struct lzma_simple_s {
	uint32_t prev_mask;
	uint32_t prev_pos;
};

// xz-5.0.1/src/liblzma/simple/x86.c:26: //
static size_t
	...
	while (buffer_pos <= limit) {
		...
		if (Test86MSByte(b)
			...
			while (true) {
				...
				const uint32_t i =
				    MASK_TO_BIT_NUMBER[prev_mask >> 1];
...
// xz-5.0.1/src/liblzma/simple/x86.c:121: //
static lzma_ret
...
// xz-5.0.1/src/liblzma/simple/x86.c:143: //
extern lzma_ret
