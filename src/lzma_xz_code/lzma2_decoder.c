...
// xz-5.0.1/src/liblzma/lzma/lzma2_decoder.c:19: //
struct lzma_coder_s {
	enum sequence {
		SEQ_CONTROL,
		SEQ_UNCOMPRESSED_1,
...
// xz-5.0.1/src/liblzma/lzma/lzma2_decoder.c:56: //
static lzma_ret
	     ...
	     size_t in_size)
{
	...
	while (*in_pos < in_size || coder->sequence == SEQ_LZMA)
		...
		case SEQ_LZMA:{
				...
				const lzma_ret ret =
				    coder->lzma.code(coder->lzma.coder,
		...
		case SEQ_COPY:{
				...
				dict_write(dict, in, in_pos, in_size,
					   &coder->compressed_size);
				if (coder->compressed_size != 0)
					return LZMA_OK;
...
// xz-5.0.1/src/liblzma/lzma/lzma2_decoder.c:207: //
static void lzma2_decoder_end(lzma_coder * coder, lzma_allocator * allocator)
{
...
// xz-5.0.1/src/liblzma/lzma/lzma2_decoder.c:219: //
static lzma_ret
		   ...
		   const void *opt, lzma_lz_options * lz_options)
{
	...
	return lzma_lzma_decoder_create(&lz->coder->lzma, allocator, options,
					lz_options);
}

// xz-5.0.1/src/liblzma/lzma/lzma2_decoder.c:243: //
extern lzma_ret
...
// xz-5.0.1/src/liblzma/lzma/lzma2_decoder.c:254: //
...
// xz-5.0.1/src/liblzma/lzma/lzma2_decoder.c:262: //
extern lzma_ret
