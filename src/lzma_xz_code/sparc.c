...
// xz-5.0.1/src/liblzma/simple/sparc.c:17: //
static size_t
sparc_code(lzma_simple * simple lzma_attribute((unused)), uint32_t now_pos,
...
// xz-5.0.1/src/liblzma/simple/sparc.c:56: //
static lzma_ret
sparc_coder_init(lzma_next_coder * next, lzma_allocator * allocator,
		 const lzma_filter_info * filters, bool is_encoder)
{
	return lzma_simple_coder_init(next, allocator, filters, &sparc_code, 0,
				      4, 4, is_encoder);
}

// xz-5.0.1/src/liblzma/simple/sparc.c:70: //
extern lzma_ret
